    ...
    const progressData = {
      ...
      step_data: {
        identity: profile ? {
          ...
          ...(user.user_metadata?.identity_data || user.user_metadata?.identity_metadata || {})
        } : undefined,
        education: user.user_metadata?.education_data || undefined,
        skills: user.user_metadata?.skills_data || undefined,
        experience: user.user_metadata?.experience_data || undefined,
        'career-goals': user.user_metadata?.['career-goals_data'] || profile?.career_goals || undefined,
        'global-preferences': user.user_metadata?.['global-preferences_data'] || undefined,
        portfolio: user.user_metadata?.portfolio_data || undefined,
      },
    };
